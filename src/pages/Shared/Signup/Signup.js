    ...
    return (
        <>
            <div className="min-h-screen p-8 mb-0 hero " style={{ backgroundImage: `url(${login})` }}>
                ...
                <div className="w-full max-w-md mt-8 shadow-2xl card shadow-cyan-400 glass">
                    ...
                    <form onSubmit={handleSubmit(handleOnSubmit)} className="card-body ">
                        ...
                        <div className="form-control">
                            ...
                            {errors.role && <span className='text-red-600'>This role  is required</span>}
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="mt-6 form-control">
                            <button className="btn bg-[#21acb1] text-xl mx-2 text-white border-spacing-0">Signup</button>
                        </div>
